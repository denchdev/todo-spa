...
RSpec.describe AttachedFilesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all attached_files as @attached_files" do
      attached_file = AttachedFile.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested attached_file as @attached_file" do
      attached_file = AttachedFile.create! valid_attributes
      get :show, {:id => attached_file.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested attached_file as @attached_file" do
      attached_file = AttachedFile.create! valid_attributes
      get :edit, {:id => attached_file.to_param}, valid_session
      expect(assigns(:attached_file)).to eq(attached_file)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new AttachedFile" do
        expect {
          post :create, {:attached_file => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved attached_file as @attached_file" do
        post :create, {:attached_file => invalid_attributes}, valid_session
        expect(assigns(:attached_file)).to be_a_new(AttachedFile)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested attached_file" do
        attached_file = AttachedFile.create! valid_attributes
        put :update, {:id => attached_file.to_param, :attached_file => new_attributes}, valid_session
      ...
      it "assigns the requested attached_file as @attached_file" do
        attached_file = AttachedFile.create! valid_attributes
        put :update, {:id => attached_file.to_param, :attached_file => valid_attributes}, valid_session
        expect(assigns(:attached_file)).to eq(attached_file)
      end
    ...
    context "with invalid params" do
      it "assigns the attached_file as @attached_file" do
        attached_file = AttachedFile.create! valid_attributes
        put :update, {:id => attached_file.to_param, :attached_file => invalid_attributes}, valid_session
        expect(assigns(:attached_file)).to eq(attached_file)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested attached_file" do
      attached_file = AttachedFile.create! valid_attributes
      expect {
        delete :destroy, {:id => attached_file.to_param}, valid_session
      }.to change(AttachedFile, :count).by(-1)
    end
